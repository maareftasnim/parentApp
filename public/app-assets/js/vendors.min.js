            ...
            return _inherits(B, Component),
                _createClass(B, [{
                    ...
                    value: function(t, e, i, n, s, o) {
                        ...
                        v += '<button class="month-prev' + (f ? "" : " is-disabled") + '" type="button"><path d="M15.41 16.09l-4.58-4.59 4.58-4.59L14 5.5l-6 6 6 6z"/><path d="M0-.5h24v24H0z" fill="none"/></svg></button>',
                            v += '<div class="selects-container">',
                            u.showMonthAfterYear ? v += r + a : v += a + r,
                            v += "</div>",
                        c && (0 === n || u.minMonth >= n) && (f = !1),
                        p && (11 === n || u.maxMonth <= n) && (m = !1);
                        return (v += '<button class="month-next' + (m ? "" : " is-disabled") + '" type="button"></button>') + "</div>"
                    }
                }, {
                    key: "draw",
                    value: function(t) {
